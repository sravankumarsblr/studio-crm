...
export function EditProfilingForm({
  ...
  const form = useForm<EditProfilingFormValues>({
    ...
    defaultValues: {
      ...
      willingToPayPremium: company.willingToPayPremium,
      relationshipLength: company.relationshipLength,
      engagementLevel: company.engagementLevel,
      loyaltyAdvocacy: company.loyaltyAdvocacy || [],
    },
  });
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 px-1">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            render={({ field }) => (
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                    <SelectTrigger><SelectValue placeholder="Select decision cycle" /></SelectTrigger>
                    </FormControl>
                    <SelectContent>
                    {decisionCycles.map(item => <SelectItem key={item} value={item}>{item}</SelectItem>)}
                    </SelectContent>
                </Select>
                <FormMessage />
                </FormItem>
            ...
            render={({ field }) => (
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                    <SelectTrigger><SelectValue placeholder="Select service expectation" /></SelectTrigger>
                    </FormControl>
                    <SelectContent>
                    {serviceExpectations.map(item => <SelectItem key={item} value={item}>{item}</SelectItem>)}
                    </SelectContent>
                </Select>
                <FormMessage />
                </FormItem>
            ...
            render={({ field }) => (
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                    {preferences.map(item => <SelectItem key={item} value={item}>{item}</SelectItem>)}
                    </SelectContent>
                </Select>
                <FormMessage />
                </FormItem>
            ...
            render={({ field }) => (
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                    <SelectTrigger><SelectValue placeholder="Select payment cycle" /></SelectTrigger>
                    </FormControl>
                    <SelectContent>
                    {paymentCycles.map(item => <SelectItem key={item} value={item}>{item}</SelectItem>)}
                    </SelectContent>
                </Select>
                <FormMessage />
                </FormItem>
            ...
            render={({ field }) => (
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                    <SelectTrigger><SelectValue placeholder="Select usage profile" /></SelectTrigger>
                    </FormControl>
                    <SelectContent>
                    {usageProfiles.map(item => <SelectItem key={item} value={item}>{item}</SelectItem>)}
                    </SelectContent>
                </Select>
                <FormMessage />
                </FormItem>
            ...
            render={({ field }) => (
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                    <SelectTrigger><SelectValue placeholder="Select certificate format" /></SelectTrigger>
                    </FormControl>
                    <SelectContent>
                    {certificateFormats.map(item => <SelectItem key={item} value={item}>{item}</SelectItem>)}
                    </SelectContent>
                </Select>
                <FormMessage />
                </FormItem>
            ...
            render={({ field }) => (
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                    <SelectTrigger><SelectValue placeholder="Select audit support level" /></SelectTrigger>
                    </FormControl>
                    <SelectContent>
                    {auditSupportOptions.map(item => <SelectItem key={item} value={item}>{item}</SelectItem>)}
                    </SelectContent>
                </Select>
                <FormMessage />
                </FormItem>
            ...
            render={({ field }) => (
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                    {premiumServiceOptions.map(item => <SelectItem key={item} value={item}>{item}</SelectItem>)}
                    </SelectContent>
                </Select>
                <FormMessage />
                </FormItem>
            ...
            render={({ field }) => (
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                    <SelectTrigger><SelectValue placeholder="Select relationship length" /></SelectTrigger>
                    </FormControl>
                    <SelectContent>
                    {relationshipLengths.map(item => <SelectItem key={item} value={item}>{item}</SelectItem>)}
                    </SelectContent>
                </Select>
                <FormMessage />
                </FormItem>
            ...
            render={({ field }) => (
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                    <SelectTrigger><SelectValue placeholder="Select engagement level" /></SelectTrigger>
                    </FormControl>
                    <SelectContent>
                    {engagementLevels.map(item => <SelectItem key={item} value={item}>{item}</SelectItem>)}
                    </SelectContent>
                </Select>
                <FormMessage />
                </FormItem>
        ...
        <FormField
          ...
          render={() => (
            <FormItem>
              <div className="mb-4">
                <FormLabel className="text-base">Loyalty / Advocacy</FormLabel>
                <FormDescription>
                  Select all applicable loyalty indicators.
                </FormDescription>
              </div>
