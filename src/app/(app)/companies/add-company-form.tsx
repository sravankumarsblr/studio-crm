...
import { firmographicSchema, companyIndustries, companySizes, ownershipTypes, businessStages, serviceDependencies, productPortfolios, annualSpends, decisionCycles, serviceExpectations, paymentCycles, paymentMethods, complaintFrequencies, certificateFormats, auditSupportOptions, willingnessToPayOptions, relationshipLengths, engagementLevels, loyaltyOptions, locationPreferences, employeeCounts } from "@/lib/data";


export type AddCompanyFormValues = z.infer<typeof firmographicSchema>;
...
export function AddCompanyForm({
  ...
  const form = useForm<AddCompanyFormValues>({
    ...
    defaultValues: {
        ...
        stageOfBusiness: undefined,
        accreditations: "",
        serviceDependency: undefined,
        productPortfolio: undefined,
        annualSpend: undefined,
        decisionCycle: undefined,
        serviceExpectations: undefined,
        preferences: undefined,
        paymentCycle: undefined,
        paymentMethod: undefined,
        complaints: undefined,
        certificateFormat: undefined,
        auditSupport: undefined,
        willingnessToPay: undefined,
        lengthOfRelationship: undefined,
        levelOfEngagement: undefined,
        loyalty: undefined,
    },
  });
